...
TRAIN_IMAGES_PATH = '/home/pablo.canosa/ssd/datasets_pablo/datasets_extra_ablacion/earthVQA/Train/Train/images_png/' 
TRAIN_PNG_MASKS_PATH = '/home/pablo.canosa/ssd/datasets_pablo/datasets_extra_ablacion/earthVQA/Train/Train/masks_png/'

#Test images path, use your own path    
TEST_IMAGES_PATH = '/home/pablo.canosa/ssd/datasets_pablo/datasets_extra_ablacion/earthVQA/Val/Val/images_png/' 
TEST_PNG_MASKS_PATH = '/home/pablo.canosa/ssd/datasets_pablo/datasets_extra_ablacion/earthVQA/Val/Val/masks_png/'
...
def main(args):
    ...
    stuff_dataset_id_to_contiguous_id = {i: i for i in range(9)}#The dictionaries are trivial, the id is the same as the index
    ...
    DatasetCatalog.register("earthvqa_train", lambda : get_gaofen_dict(dataset_path_image,dataset_path_png_mask,dataset_path_tif_mask))
    MetadataCatalog.get("earthvqa_train").stuff_classes = ALL_CLASSES
    MetadataCatalog.get("earthvqa_train").ignore_label = 255
    MetadataCatalog.get("earthvqa_train").thing_dataset_id_to_contiguous_id = stuff_dataset_id_to_contiguous_id
    MetadataCatalog.get("earthvqa_train").stuff_dataset_id_to_contiguous_id = stuff_dataset_id_to_contiguous_id
    
    MetadataCatalog.get("earthvqa_train").stuff_colors = COLOR_LIST
    ...
    DatasetCatalog.register("earthvqa_test", lambda : get_gaofen_dict(dataset_path_image_test,dataset_path_png_mask_test,dataset_path_tif_mask_test))
    MetadataCatalog.get("earthvqa_test").stuff_classes = ALL_CLASSES 
    MetadataCatalog.get("earthvqa_test").stuff_dataset_id_to_contiguous_id = stuff_dataset_id_to_contiguous_id
    MetadataCatalog.get("earthvqa_test").stuff_colors = COLOR_LIST

    MetadataCatalog.get("earthvqa_test").ignore_label = 0 
    MetadataCatalog.get("earthvqa_test").evaluator_type = "sem_seg"
