...
def main(args):
    ...
    dataset_path_image = '/home/pablo.canosa/wip/datasets/split_gaofen/train_8bit/' 
    ...
    # test trials
    dataset_path_image_test = '/home/pablo.canosa/wip/datasets/split_gaofen/test_8bit/' 
    ...
    #MetadataCatalog.get("gaofen_test").stuff_classes = ALL_CLASSES # sino da error en al visualizar
    MetadataCatalog.get("gaofen_test").thing_dataset_id_to_contiguous_id = thing_dataset_id_to_contiguous_id
    MetadataCatalog.get("gaofen_test").evaluator_type = "sem_seg"# este con esta version falla si no se añade stuff a la metdata
